...
const EMAILJS_CONFIG = {
  PUBLIC_KEY: "0h5Mwb3UaRekigeqx",    // Clave pública de EmailJS
  SERVICE_ID: "service_75v1rh8",       // ID del servicio de email configurado
  TEMPLATE_ID: "template_zpvp5gr"      // ID de la plantilla de email
};
